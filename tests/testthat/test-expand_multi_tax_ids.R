...
basic_blast_result <- function() {
  readr::read_tsv(
    I(
      ...
      Q5	S104-1	10	10	0.001	4	4	4	TTTTT	1041;1042;1043;1044"
    ),
    trim_ws = TRUE,
    col_names = c(
      "query_accession",
...
expanded_result <- function() {
  readr::read_tsv(
    I(
      ...
      Q5	S104-1	10	10	0.001	4	4	4	TTTTT	1041
      Q5	S104-2	10	10	0.001	4	4	4	TTTTT	1042
      Q5	S104-3	10	10	0.001	4	4	4	TTTTT	1043
      Q5	S104-4	10	10	0.001	4	4	4	TTTTT	1044"
    ),
    trim_ws = TRUE,
    col_names = c(
      "query_accession",
